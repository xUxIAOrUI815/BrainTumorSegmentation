...
from model.helper import even_pad
...
class Stage(nn.Module):
    ...
    class Options:
        ...
        window_attention_optins: WindowAttention.Options
        depth: int
    ...
    def __init__(self, opt: Options):
        ...
        self.options = opt
        wopt = opt.window_attention_optins
...
class PatchMerging(nn.Module):
    ...
    def forward(self, x: torch.Tensor)->torch.Tensor:
        ...
        x = torch.cat([x000, x001, x010, x100, x011, x101, x110, x111], -1)
